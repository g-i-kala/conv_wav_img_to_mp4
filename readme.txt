...
You can change properites of the video by giving it different specs. 

conv_wav_to_mp4_v2.py

This script takes as an input an image and an wav file and creates mp4 video fo it. 
The lenght of the video is same as the lenght of the audio file. 
You can change properites of the video by giving it different specs. 
